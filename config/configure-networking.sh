...
kcf_scripts/configure_connection.sh --interface_type=wifi --method=static --interface_name=en0 --ssid=HouseOfDoon --psk=RubberBiscuits --interface_type=wifi --method=static --interface_name=en0 --ip_address=192.168.1.123 --gateway=192.168.1.1  --dns_entries='8.8.8.8 '  --metric=1
kcf_scripts/configure_connection.sh --interface_type=ethernet --method=static --interface_name=en0 --ip_address=192.168.151.100 --gateway=192.168.151.100  --dns_entries='8.8.8.8 ' 
